...
const StyleSelector = ({
  ...
  const styleDescriptions: Record<ThumbnailStyle, string> = {
    ...
    Minimalist: "Clean and simple design with lots of white spaces.",
    Photorealistic: "Lifelike images with realistic lighting and textures.",
    Illustrated: "Hand-drawn or digitally created illustrations.",
    "Tech/Futuristic":
      "Sleek, modern designs with a focus on technology and innovation.",
  };
  ...
  return (
    <div className="relative space-y-3 dark">
      ...
      {isOpen && (
        <div className="absolute bottom-0 z-50 mt-1 w-full rounded-md bg-black/20 border border-white/12 shadow-lg backdrop-blur-3xl">
