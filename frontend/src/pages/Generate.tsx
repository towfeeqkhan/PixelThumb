...
function Generate() {
  ...
  const handleGenerate = async () => {
    if (!isLoggedIn)
      return toast.error("Please log in to generate thumbnails.");
    ...
    try {
      ...
      console.error(error);
      toast.error("An error occurred while generating thumbnail.");
    } finally {
      setLoading(false);
    }
  };
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      maxLength={100}
                      placeholder="e.g, How to Master Backend Development"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="Add any specific details, mood or styles you want for your thumbnail..."
